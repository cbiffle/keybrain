...
impl Hid {
    fn on_set_config(&mut self, usb: &device::USB) {
    ...
    fn on_setup_iface_std(&mut self, setup: &SetupPacket, usb: &device::USB) {
    ...
    fn on_setup_iface_class(&mut self, setup: &SetupPacket, usb: &device::USB) {
    ...
    fn on_in(&mut self, ep: usize, usb: &device::USB, keys_down: &[[bool; 2]; 2]) {
